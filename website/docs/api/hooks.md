...
For Svelte, Vue, vanilla JS, or headless editing, see [Using the Engine Directly](/docs/react/guides/engine) — the `PlaylistEngine` class works without any framework.
:::
