...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoaderFactory = __webpack_require__(1);
	...
	var _class = (function () {
	    function _class(tracks) {
	        ...
	        this.tracks = tracks;
	        this.config = (0, _config2.default)(options);
	    }
	    ...
	    _createClass(_class, [{
	        ...
	        value: function load(trackList) {
	            ...
	            var loadPromises = trackList.map(function (trackInfo) {
	                var loader = _LoaderFactory2.default.createLoader(trackInfo.src, _this.config.ac);
	            ...
	            return Promise.all(loadPromises).then(function (audioBuffers) {
	                var TrackEditors = audioBuffers.map(function (audioBuffer) {
	                    var TrackEditor = new _Track2.default(audioBuffer);

	                    return TrackEditor;
	                });

	                return TrackEditors;
	            }).then(function (TrackEditors) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BlobLoader = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Loader2 = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _peaks = __webpack_require__(43);

	var _peaks2 = _interopRequireDefault(_peaks);

	var _Playout = __webpack_require__(44);
	...
	var _class = (function () {
	    function _class(audioBuffer) {
	        var start = arguments.length <= 1 || arguments[1] === undefined ? undefined : arguments[1];
	        var end = arguments.length <= 2 || arguments[2] === undefined ? undefined : arguments[2];
	        var cues = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];
	        var fades = arguments.length <= 4 || arguments[4] === undefined ? {} : arguments[4];
	        var enabledStates = arguments.length <= 5 || arguments[5] === undefined ? {} : arguments[5];
	        ...
	        this.enabledStates = _lodash2.default.assign(defaultStatesEnabled, enabledStates);

	        this.playout = new _Playout2.default();
	    }
	    ...
	    _createClass(_class, [{
	        ...
	        key: 'removeFadeType',
	        value: function removeFadeType(type) {
	            var _this = this;

	            _lodash2.default.forOwn(this.fades, function (fade, id) {
	                if (fade.type === type) {
	                    _this.removeFade(id);
	                }
	            });
	        ...
	        */
	        ...
	        key: 'leaveCurrentState',
	        value: function leaveCurrentState() {
	        ...
	        */
	        ...
	        value: function schedulePlay(now, startTime, endTime, options) {
	            ...
	            _lodash2.default.forOwn(this.fades, function (fade) {
	                ...
	                if (relPos < fade.end) {
	                    ...
	                    switch (fade.type) {
	                        case FADEIN:
	                            _this2.playout.applyFadeIn(startTime, duration, fade.shape);
	                            break;
	                        case FADEOUT:
	                            _this2.playout.applyFadeOut(startTime, duration, fade.shape);
	                            break;
	                        default:
	        ...
	        key: 'render',
	        value: function render() {
	            return (0, _h2.default)("div.channel-wrapper.state-select", { attributes: {
	                    "style": "width: 1324px; margin-left: 200px; height: 100px;"
	                } }, [(0, _h2.default)("div.controls", { attributes: {
	                    "style": "height: 100px; width: 200px; position: absolute; left: 0px; z-index: 1000;"
	                } }, [(0, _h2.default)("header", ["Vocals30.mp3"]), (0, _h2.default)("div.btn-group", [(0, _h2.default)("span.btn.btn-default.btn-xs.btn-mute", ["Mute"]), (0, _h2.default)("span.btn.btn-default.btn-xs.btn-solo", ["Solo"])]), (0, _h2.default)("label", [(0, _h2.default)("input.volume-slider", { attributes: {
	                    "type": "range",
	                    "min": "0",
	                    "max": "100",
	                    "value": "100"
	                } })])]), (0, _h2.default)("div.waveform", { attributes: {
	                    "style": "height: 100px; width: 1324px; position: relative;"
	                } }, [(0, _h2.default)("div.cursor", { attributes: {
	                    "style": "position: absolute; box-sizing: content-box; margin: 0px; padding: 0px; top: 0px; left: 0px; bottom: 0px; z-index: 100;"
	                } }), (0, _h2.default)("div.channel.channel-0", { attributes: {
	                    "style": "width: 1324px; height: 100px; top: 0px; left: 0px; position: absolute; margin: 0px; padding: 0px; z-index: 1;"
	                } }, [(0, _h2.default)("div.channel-progress", { attributes: {
	                    "style": "position: absolute; width: 0px; height: 100px; z-index: 2;"
	                } }), (0, _h2.default)("canvas", { attributes: {
	                    "width": "1324",
	                    "height": "100",
	                    "data-offset": "0",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rng = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isVThunk = __webpack_require__(32);
...
/***/ function(module, exports) {
	...
	*/
	...
	exports.default = function (channel, resolution) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fades = __webpack_require__(45);
	...
	var _class = (function () {
	    ...
	    _createClass(_class, [{
	        ...
	        */
	        ...
	        key: 'play',
	        value: function play(start, duration) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function sCurveFadeIn(start, duration) {
	    var curve = (0, _curves.sCurve)(10000, Math.PI / 2);
	...
	function createFadeIn(gain, type, start, duration) {
	    switch (type) {
	        case SCURVE:
	...
	function createFadeOut(gain, type, start, duration) {
	    switch (type) {
	        case SCURVE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (config) {
	    return _lodash2.default.assign(defaults, config);
	};
