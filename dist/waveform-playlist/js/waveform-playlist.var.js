...
/***/ function(module, exports, __webpack_require__) {
    ...
    _createClass(_class, [{
      ...
      value: function setSpeed(speed) {
        ...
        if (this.isPlaying()) this.restartPlayFrom(this.playbackSeconds);
          ...
          var channels = Object.keys(this.peaks.data).map(function (channelNum) {
            ...
            while (totalWidth > 0) {
              ...
              channelChildren.push((0, _h2.default)('canvas', {
                ...
                hook: new _CanvasHook2.default(peaks, offset, _this4.peaks.bits, canvasColor)
              }));
